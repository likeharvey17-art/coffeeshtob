...
<main id="content">
  ...
  <section class="section">
    <div class="container">
      ...
      <?php get_template_part('parts/cards-list', null, ['cards' => $cards, 'layout' => $layout]); ?>
      ...
      <?php if (trim(get_post_field('post_content', $id)) !== '') : ?>
        <div class="about-text" style="margin-top:36px">
      ...
      <div class="container">
        <div class="info-grid">
          <article class="info-card info-card--wide">
            <?php if ($outro_t) : ?><h3><?php echo esc_html($outro_t); ?></h3><?php endif; ?>
